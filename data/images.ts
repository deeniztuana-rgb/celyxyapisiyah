...
export const images = {
  ...
  services: {
    ...
    'schuco-pvc': u('photo-1558618666-fcd25c85cd64', 1200),
    'kommerling-pvc': u('photo-1600585154340-be6161a56a0c', 1200),
    ...
    'hebeschiebe-surme': u('photo-1512917774080-9991f1c4c750', 1200),
    'otomatik-kapi': u('photo-1497215728101-856f4ea42174', 1200),
    'salamander-pvc': u('photo-1503387762-592deb58ef4e', 1200),
